                    ...
                    <div class="uk-panel ">
                        <div class="uk-width-large-4-4 uk-text-center uk-margin-large">
                            <div class="uk-margin-bottom uk-margin-top">
                                <h1 class="uk-heading-large uk-margin-large-top" style="color:#000">{{$article->title}}</h1>
                            </div>
                        </div>
                    </div>
            ...
            <div class="uk-grid" data-uk-grid-margin>
                <div class="uk-width-medium-3-4">
                    ...
                    <article class="uk-article">
                        ...
                        <p class="uk-article-meta">Written by Author on <?php $date = date_create($article->updated_at); echo date_format($date, 'jS F Y H:i:s');?>.
