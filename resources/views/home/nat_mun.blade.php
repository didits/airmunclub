        ...
        <div id="tm-top" class="tm-top uk-block uk-block-muted">
            ...
            <section class="uk-grid uk-grid-match" data-uk-grid-margin>
                <div class="uk-width-medium-1-2">
                    ...
                    <div class="uk-panel  uk-text-center uk-width-large-4-4 uk-container-center">


                        <p align="left">{!! $mun->description !!}</p>
                ...
                <div class="uk-width-medium-1-2">
                    ...
                    <div class="uk-panel  uk-text-center uk-width-large-3-4 uk-container-center">
                        ...
                        <a href="{{$mun->link}}"><button style="width:200px" class="uk-button" type="button submit">Apply</button></a>
            ...
            <div class="uk-grid" data-uk-grid-match data-uk-grid-margin>
                ...
                <main class="uk-width-1-1">
                    ...
                    <div class="uk-grid uk-grid-small uk-grid-width-medium-1-3 uk-margin-large" data-uk-grid-margin>
                        ...
                        <div>
                            <div class="uk-panel">
                                <div class="uk-overlay uk-overlay-hover" data-uk-modal="{target:'#home-1'}" style="background-image:url('{{$mun->path1}}'); display:block; width:100%; height:250px; background-size:cover; background-position:top">
                       ...
                       <div>
                         <div class="uk-panel">
                            <div class="uk-overlay uk-overlay-hover" data-uk-modal="{target:'#home-2'}" style="background-image:url('{{$mun->path2}}'); display:block; width:100%; height:250px; background-size:cover; background-position:top">
                                <div class="uk-overlay-panel uk-overlay-icon uk-overlay-background uk-overlay-fade"></div>
                                <a class="uk-position-cover" href="#" data-uk-lightbox=""></a>
                            </div>
                   ...
                   <div>
                    <div class="uk-panel">
                        <div class="uk-overlay uk-overlay-hover" data-uk-modal="{target:'#home-3'}" style="background-image:url('{{$mun->path3}}'); display:block; width:100%; height:250px; background-size:cover; background-position:top" >
                            <div class="uk-overlay-panel uk-overlay-icon uk-overlay-background uk-overlay-fade"></div>
                            <a class="uk-position-cover" href="#" data-uk-lightbox=""></a>
                        </div>
